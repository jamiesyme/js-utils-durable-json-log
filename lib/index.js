...
export function openJsonLog (path)
{
	...
	let entries = deserializeEntries(await readFile(path, 'utf8'))
	...
	function createWriteStream ()
	{
		...
		return new WritableStream({
			...
			async write (value)
			{
				...
				// closing the log and re-opening it later. Otherwise, some
				// edge cases, such as date [de]serialization, may not get
				// handled correctly.
